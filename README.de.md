...
Das Skill druckt eine Live-UI-URL:

```
UI: https://stagent.worldstatelabs.com/s/<session_id>
```

In den Browser einfügen und die Stage-Timeline, gerenderte Artifacts und `git diff baseline..HEAD` per SSE live mitverfolgen.
