...
Start the `meta-workflow` skill with the user's task.
...
Invoke `Skill("meta-workflow:meta-workflow")` and follow its instructions exactly. The skill is self-contained — do NOT invoke any other skill before, during, or after.
